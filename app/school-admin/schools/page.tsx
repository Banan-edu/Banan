...
import { Sidebar, adminLinks, schoolAdminLinks } from '@/components/Sidebar';
  ...
  return (
    <div className={`flex daysH min-h-screen bg-gray-50`}>
      ...
      <main className="flex-1 px-8 py-8">
        ...
        <SchoolsTable apiEndpoint={'/api/school-admin/schools'} role={'school-admin'} hideAddButton={Role === 'admin' ? false:true} showDelete={Role === 'admin' ? true:false} />
      </main>
    </div>
  );
}
